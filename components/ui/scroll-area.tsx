...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    className={cn(
      ...
      // Warehouse-friendly scrollbar styling - larger for gloved hands
      orientation === "vertical" &&
  ...
  >
    <ScrollAreaPrimitive.ScrollAreaThumb
      className={cn(
        ...
        // Warehouse-friendly thumb styling - more visible and larger
        "bg-slate-400 hover:bg-slate-500 active:bg-slate-600",
        "transition-colors duration-200",
        // Ensure minimum size for touch
        orientation === "vertical" ? "min-h-[20px]" : "min-w-[20px]"
      )}
    />
  </ScrollAreaPrimitive.ScrollAreaScrollbar>
))
