                          ...
                          <div className="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                            <div>
                              <p className="text-sm text-gray-900">
                                <span data-activity-type={activity.activityType}>{activity.activityDescription}</span>
                              </p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-lg shadow p-4">
          ...
          <p className="text-2xl font-semibold text-gray-900">
            {activities.filter((activity) => activity.activityType === 'document_uploaded').length}
          </p>
        </div>
        <div className="bg-white rounded-lg shadow p-4">
          <p className="text-sm text-gray-500">Notifications</p>
          <p className="text-2xl font-semibold text-gray-900">
            {activities.filter((activity) => activity.activityType === 'notification_sent').length}
          </p>
        </div>
        <div className="bg-white rounded-lg shadow p-4">
